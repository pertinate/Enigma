...
public class Drag : MonoBehaviour, IPointerDownHandler, IDragHandler {
    ...
    public void OnPointerDown(PointerEventData data)
    {
        ...
        RectTransformUtility.ScreenPointToLocalPointInRectangle(panelRectTransform, data.position, data.pressEventCamera, out pointerOffest);
    }
    public void OnDrag(PointerEventData data)
    {
        ...
        {
            panelRectTransform.localPosition = localPointerPosition - pointerOffest;
        }
    }
